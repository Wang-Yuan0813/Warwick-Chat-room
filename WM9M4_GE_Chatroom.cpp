...
int main(int, char**)
{
    ...
    HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"ChatRoomWindow", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX, 600, 100, 1050, 750 , nullptr, nullptr, wc.hInstance, nullptr);

    //HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear ImGui DirectX12 Example", WS_OVERLAPPEDWINDOW, 600, 100, (int)(400 * main_scale), (int)(600 * main_scale), nullptr, nullptr, wc.hInstance, nullptr);
    ...
    style.FontScaleDpi = 1.2f;        // Set initial font scale. (using io.ConfigDpiScaleFonts=true makes this unnecessary. We leave both here for documentation purpose)
    ...
    while (!done)
    {
        ...
        ImGui::NewFrame();
#if 1
        // Main chat window: no move / resize / title / menubar, fixed to main screen
        chatWindow.render(client, hasName);
